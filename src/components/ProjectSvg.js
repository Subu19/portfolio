...
import { ReactComponent as Svg } from "../assets/Project.svg";
const ProjectSvg = () => {
  useEffect(() => {
    !(function (t, n) {
        ...
        animations: [
          {
            elements: {
              eFjhVl6E7QW3: {
                transform: {
                  data: {
                    o: { x: 205.502632, y: 62.503948, type: "corner" },
                    t: { x: -205.502632, y: -62.503948 },
                  },
                  keys: {
                    r: [
                      { t: 0, v: 360 },
              ...
              eFjhVl6E7QW8: {
                transform: {
                  data: {
                    o: { x: 117.333084, y: 44.355635, type: "corner" },
                    t: { x: -117.333084, y: -44.355635 },
                  },
                  keys: {
                    r: [
                      { t: 0, v: 360 },
              ...
              eFjhVl6E7QW13: {
                transform: {
                  data: {
                    o: { x: 153.887369, y: 47.364601, type: "corner" },
                    t: { x: -153.264973, y: -43.63153 },
                  },
                  keys: {
                    r: [
                      { t: 0, v: 0 },
                      ...
                      { t: 9000, v: 877.386103 },
                      { t: 9500, v: 915.854505 },
                      { t: 10000, v: 955.062803 },
                    ],
                  },
                },
              },
            },
            s: "|",
          },
        ],
        options: "MODAxMDg4MmY4MDgxNmHU3ZjgxMmY0NzJmNzkO3YzZlNzEyZjhh",
      },
      "__SVGATOR_PLAYER__",
      window
    );
  }, []);
  return <Svg className="projectSvg hoverable"></Svg>;
};
